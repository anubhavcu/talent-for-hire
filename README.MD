...
| Anubhav Srivastava | Software Development / FullStack Web Development / Entry-level Developer roles | Delhi, India | Javascript, React, Redux, Node.js, Express, Python, HTML/CSS, Git, MySQL, Bootstrap, Unit testing, Docker(Familiar), Linux, GraphQL(Familiar) | Remote / Onsite / Relocation | [Website](https://anubhavportfolio.netlify.app/) <br /> [LinkedIn](https://www.linkedin.com/in/anubhavksr/) <br /> [Email](mailto:anubhavcs.py@gmail.com) <br /> [GitHub](https://github.com/anubhavcu) <br /> [Twitter](https://twitter.com/anubhav_sr) | 
